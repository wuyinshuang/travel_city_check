...
-- Insert provinces (simplified for demonstration)
INSERT INTO provinces (name, code, geojson) VALUES 
...
-- Insert cities for Beijing (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Shanghai (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Guangdong (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Jiangsu (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Zhejiang (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Hunan (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Sichuan (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('成都市', 22, '510100', '{"type":"Feature","properties":{"name":"成都市"},"geometry":{"type":"Polygon","coordinates":[[[103.8,30.6],[104.1,30.6],[104.1,30.8],[103.8,30.8],[103.8,30.6]]]}}'),
('绵阳市', 22, '510700', '{"type":"Feature","properties":{"name":"绵阳市"},"geometry":{"type":"Polygon","coordinates":[[[104.6,31.4],[104.8,31.4],[104.8,31.6],[104.6,31.6],[104.6,31.4]]]}}'),
('德阳市', 22, '510600', '{"type":"Feature","properties":{"name":"德阳市"},"geometry":{"type":"Polygon","coordinates":[[[104.2,31.0],[104.4,31.0],[104.4,31.2],[104.2,31.2],[104.2,31.0]]]}}');

-- Insert cities for Shaanxi (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('西安市', 26, '610100', '{"type":"Feature","properties":{"name":"西安市"},"geometry":{"type":"Polygon","coordinates":[[[108.9,34.2],[109.1,34.2],[109.1,34.35],[108.9,34.35],[108.9,34.2]]]}}'),
('宝鸡市', 26, '610300', '{"type":"Feature","properties":{"name":"宝鸡市"},"geometry":{"type":"Polygon","coordinates":[[[107.1,34.3],[107.3,34.3],[107.3,34.5],[107.1,34.5],[107.1,34.3]]]}}'),
('咸阳市', 26, '610400', '{"type":"Feature","properties":{"name":"咸阳市"},"geometry":{"type":"Polygon","coordinates":[[[108.7,34.3],[108.9,34.3],[108.9,34.5],[108.7,34.5],[108.7,34.3]]]}}');

-- Insert cities for Hubei (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Henan (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Shandong (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Liaoning (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Heilongjiang (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Jilin (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Anhui (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Fujian (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Jiangxi (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Guangxi (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Chongqing (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('渝中区', 21, '500103', '{"type":"Feature","properties":{"name":"渝中区"},"geometry":{"type":"Polygon","coordinates":[[[106.5,29.5],[106.6,29.5],[106.6,29.6],[106.5,29.6],[106.5,29.5]]]}}'),
('江北区', 21, '500105', '{"type":"Feature","properties":{"name":"江北区"},"geometry":{"type":"Polygon","coordinates":[[[106.5,29.6],[106.7,29.6],[106.7,29.8],[106.5,29.8],[106.5,29.6]]]}}');

-- Insert cities for Yunnan (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('昆明市', 24, '530100', '{"type":"Feature","properties":{"name":"昆明市"},"geometry":{"type":"Polygon","coordinates":[[[102.7,25.0],[102.9,25.0],[102.9,25.2],[102.7,25.2],[102.7,25.0]]]}}'),
('大理市', 24, '532900', '{"type":"Feature","properties":{"name":"大理市"},"geometry":{"type":"Polygon","coordinates":[[[100.2,25.7],[100.4,25.7],[100.4,25.9],[100.2,25.9],[100.2,25.7]]]}}');

-- Insert cities for Guizhou (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('贵阳市', 23, '520100', '{"type":"Feature","properties":{"name":"贵阳市"},"geometry":{"type":"Polygon","coordinates":[[[106.6,26.5],[106.8,26.5],[106.8,26.7],[106.6,26.7],[106.6,26.5]]]}}'),
('遵义市', 23, '520300', '{"type":"Feature","properties":{"name":"遵义市"},"geometry":{"type":"Polygon","coordinates":[[[106.9,27.7],[107.1,27.7],[107.1,27.9],[106.9,27.9],[106.9,27.7]]]}}');

-- Insert cities for Hebei (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Shanxi (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Tianjin (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Inner Mongolia (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Gansu (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('兰州市', 27, '620100', '{"type":"Feature","properties":{"name":"兰州市"},"geometry":{"type":"Polygon","coordinates":[[[103.8,36.0],[104.0,36.0],[104.0,36.2],[103.8,36.2],[103.8,36.0]]]}}'),
('嘉峪关市', 27, '620200', '{"type":"Feature","properties":{"name":"嘉峪关市"},"geometry":{"type":"Polygon","coordinates":[[[98.2,39.8],[98.4,39.8],[98.4,40.0],[98.2,40.0],[98.2,39.8]]]}}');

-- Insert cities for Qinghai (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('西宁市', 28, '630100', '{"type":"Feature","properties":{"name":"西宁市"},"geometry":{"type":"Polygon","coordinates":[[[101.7,36.6],[101.9,36.6],[101.9,36.8],[101.7,36.8],[101.7,36.6]]]}}');

-- Insert cities for Ningxia (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('银川市', 29, '640100', '{"type":"Feature","properties":{"name":"银川市"},"geometry":{"type":"Polygon","coordinates":[[[106.2,38.4],[106.4,38.4],[106.4,38.6],[106.2,38.6],[106.2,38.4]]]}}');

-- Insert cities for Xinjiang (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('乌鲁木齐市', 30, '650100', '{"type":"Feature","properties":{"name":"乌鲁木齐市"},"geometry":{"type":"Polygon","coordinates":[[[87.6,43.8],[87.8,43.8],[87.8,44.0],[87.6,44.0],[87.6,43.8]]]}}'),
('喀什市', 30, '653100', '{"type":"Feature","properties":{"name":"喀什市"},"geometry":{"type":"Polygon","coordinates":[[[75.9,39.4],[76.1,39.4],[76.1,39.6],[75.9,39.6],[75.9,39.4]]]}}');

-- Insert cities for Hainan (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
...
-- Insert cities for Tibet (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('拉萨市', 25, '540100', '{"type":"Feature","properties":{"name":"拉萨市"},"geometry":{"type":"Polygon","coordinates":[[[91.1,29.6],[91.3,29.6],[91.3,29.8],[91.1,29.8],[91.1,29.6]]]}}');

-- Insert cities for Hong Kong (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('香港岛', 31, '810101', '{"type":"Feature","properties":{"name":"香港岛"},"geometry":{"type":"Polygon","coordinates":[[[114.1,22.25],[114.2,22.25],[114.2,22.35],[114.1,22.35],[114.1,22.25]]]}}');

-- Insert cities for Macau (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('澳门半岛', 32, '820101', '{"type":"Feature","properties":{"name":"澳门半岛"},"geometry":{"type":"Polygon","coordinates":[[[113.55,22.15],[113.58,22.15],[113.58,22.18],[113.55,22.18],[113.55,22.15]]]}}');

-- Insert cities for Taiwan (simplified)
INSERT INTO cities (name, province_id, code, geojson) VALUES 
('台北市', 33, '710101', '{"type":"Feature","properties":{"name":"台北市"},"geometry":{"type":"Polygon","coordinates":[[[121.5,25.0],[121.6,25.0],[121.6,25.15],[121.5,25.15],[121.5,25.0]]]}}'),
('高雄市', 33, '710201', '{"type":"Feature","properties":{"name":"高雄市"},"geometry":{"type":"Polygon","coordinates":[[[120.3,22.6],[120.4,22.6],[120.4,22.75],[120.3,22.75],[120.3,22.6]]]}}');

-- Create admin user (password is 'admin123' hashed with BCrypt)
INSERT INTO users (username, password, created_at) VALUES 
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMye.IjzqAKL9xL5jvMFVdNJHvGCgTq/VEq', NOW());
